...
\textbf{Scope of the strictness statement.} Under the reading in which
...
equivalently to the absorbable span of the transmitted class. Whether the
FULL transmitted class covers the rigidity family up to uniform correlation
is precisely the twisted trilinear inequality (Open Problem O1). The isolated
open subproblem is therefore: does
...
unimodular $d$ — together with the parallelogram-equation converse
(Conjecture D'). These two questions constitute the exact open residue; no
other gap remains between the rigidity family and the transmitted readings.
